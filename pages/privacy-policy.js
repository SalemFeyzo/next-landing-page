...
const data = [
  {
    title: "Who we are",
    body: "This website is operated by Techomoda and (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us. This policy sets out how we process any personal data we collect from you or that you provide to us through our website. We confirm that we will keep your information secure and that we will comply fully with all applicable UK Data Protection legislation and regulations. Please read the following carefully to understand what happens to personal data that you choose to provide to us, or that we collect from you when you visit this site. By visiting www.techomoda.com or techomoda.com (our website) you are accepting and consenting to the practices described in this policy.",
  },
  {
    title: "What personal data we collect and why we collect it",
    body: "We may collect, store and use the following kinds of personal information about individuals who visit and use our website:",
  },
  {
    title: "Comments",
  ...
  },
  {
    ...
    body: "Any changes we may make to our privacy policy in the future will be posted on this page and, where appropriate, notified to you by e-mail. Please check back frequently to see any updates or changes to our privacy policy.",
  },
  {
    title: "How we protect your data",
    body: "Any information you provide to us will either be emailed directly to us or may be stored on a secure server located in France. We use a trusted third-party website and hosting provider to facilitate the running and management of this website. Hosting provider meet high data protection and security standards and are bound by contract to keep any information they process on our behalf confidential. Any data that may be collected through this website that hosting provider process, is kept secure and only processed in the manner we instruct them to. Hosting provider cannot access, provide, rectify or delete any data that they store on our behalf without permission. We do not rent, sell or share personal information about you with other people or non-affiliated companies.",
  },
  {
    title: "Contact information",
    body: "Questions, comments and requests regarding this privacy policy are welcomed and should be addressed to cloud@techomoda.com.",
  },
];
